...
namespace
{
    monstats_t monsters[] = {
        ...
        {1, 1, 1, 1, 1, Speed::SLOW, 26, 0, _("Peasant"), _("Peasants"), {15, 0, 0, 0, 0, 0, 0}},
        {5, 3, 2, 3, 11, Speed::VERYSLOW, 8, 12, _("Archer"), _("Archers"), {150, 0, 0, 0, 0, 0, 0}},
        {5, 3, 2, 3, 11, Speed::AVERAGE, 8, 24, _("Ranger"), _("Rangers"), {200, 0, 0, 0, 0, 0, 0}},
        {5, 9, 3, 5, 16, Speed::AVERAGE, 5, 0, _("Pikeman"), _("Pikemen"), {210, 0, 0, 0, 0, 0, 0}},
        {5, 9, 3, 5, 21, Speed::FAST, 5, 0, _("Veteran Pikeman"), _("Veteran Pikemen"), {260, 0, 0, 0, 0, 0, 0}},
        {7, 9, 4, 7, 26, Speed::AVERAGE, 4, 0, _("Swordsman"), _("Swordsmen"), {260, 0, 0, 0, 0, 0, 0}},
        {7, 9, 4, 7, 31, Speed::FAST, 4, 0, _("Master Swordsman"), _("Master Swordsmen"), {310, 0, 0, 0, 0, 0, 0}},
        {10, 9, 5, 10, 35, Speed::VERYFAST, 3, 0, _("Cavalry"), _("Cavalries"), {340, 0, 0, 0, 0, 0, 0}},
        {10, 9, 5, 10, 45, Speed::ULTRAFAST, 3, 0, _("Champion"), _("Champions"), {415, 0, 0, 0, 0, 0, 0}},
        {11, 12, 10, 20, 60, Speed::FAST, 2, 0, _("Paladin"), _("Paladins"), {675, 0, 0, 0, 0, 0, 0}},
        {11, 12, 10, 20, 75, Speed::VERYFAST, 2, 0, _("Crusader"), _("Crusaders"), {1000, 0, 0, 0, 0, 0, 0}},

        // atck dfnc  min  max   hp             speed grwn  shots  name                  multiname            cost
        {3, 1, 1, 2, 3, Speed::AVERAGE, 12, 0, _("Goblin"), _("Goblins"), {40, 0, 0, 0, 0, 0, 0}},
        {3, 4, 2, 3, 11, Speed::VERYSLOW, 8, 8, _("Orc"), _("Orcs"), {140, 0, 0, 0, 0, 0, 0}},
        {3, 4, 3, 4, 15, Speed::SLOW, 8, 16, _("Orc Chief"), _("Orc Chiefs"), {175, 0, 0, 0, 0, 0, 0}},
        {6, 3, 3, 5, 20, Speed::VERYFAST, 5, 0, _("Wolf"), _("Wolves"), {210, 0, 0, 0, 0, 0, 0}},
        {9, 5, 4, 6, 40, Speed::VERYSLOW, 4, 0, _("Ogre"), _("Ogres"), {300, 0, 0, 0, 0, 0, 0}},
        {9, 5, 5, 7, 55, Speed::AVERAGE, 4, 0, _("Ogre Lord"), _("Ogre Lords"), {475, 0, 0, 0, 0, 0, 0}},
        {10, 5, 5, 7, 40, Speed::AVERAGE, 3, 8, _("Troll"), _("Trolls"), {575, 0, 0, 0, 0, 0, 0}},
        {10, 5, 7, 9, 40, Speed::FAST, 3, 16, _("War Troll"), _("War Trolls"), {650, 0, 0, 0, 0, 0, 0}},
        {12, 9, 12, 24, 85, Speed::FAST, 2, 0, _("Cyclops"), _("Cyclopes"), {800, 0, 0, 0, 0, 1, 0}},

        // atck dfnc  min  max   hp             speed grwn  shots  name                  multiname            cost
        {4, 2, 1, 2, 2, Speed::AVERAGE, 10, 0, _("Sprite"), _("Sprites"), {50, 0, 0, 0, 0, 0, 0}},
        {6, 5, 2, 4, 20, Speed::VERYSLOW, 6, 0, _("Dwarf"), _("Dwarves"), {190, 0, 0, 0, 0, 0, 0}},
        {6, 6, 2, 4, 20, Speed::AVERAGE, 6, 0, _("Battle Dwarf"), _("Battle Dwarves"), {235, 0, 0, 0, 0, 0, 0}},
        {5, 3, 2, 3, 16, Speed::AVERAGE, 4, 24, _("Elf"), _("Elves"), {250, 0, 0, 0, 0, 0, 0}},
        {7, 5, 2, 3, 16, Speed::VERYFAST, 4, 24, _("Grand Elf"), _("Grand Elves"), {300, 0, 0, 0, 0, 0, 0}},
        {7, 5, 5, 8, 25, Speed::FAST, 3, 8, _("Druid"), _("Druids"), {350, 0, 0, 0, 0, 0, 0}},
        {7, 7, 5, 8, 26, Speed::VERYFAST, 3, 16, _("Greater Druid"), _("Greater Druids"), {400, 0, 0, 0, 0, 0, 0}},
        {10, 9, 7, 14, 45, Speed::FAST, 2, 0, _("Unicorn"), _("Unicorns"), {515, 0, 0, 0, 0, 0, 0}},
        ...
        {4, 6, 2, 3, 15, Speed::VERYFAST, 6, 0, _("Gargoyle"), _("Gargoyles"), {200, 0, 0, 0, 0, 0, 0}},
        {6, 6, 3, 5, 25, Speed::AVERAGE, 4, 0, _("Griffin"), _("Griffins"), {320, 0, 0, 0, 0, 0, 0}},
        ...
        {8, 9, 6, 12, 75, Speed::VERYSLOW, 2, 0, _("Hydra"), _("Hydras"), {775, 0, 0, 0, 0, 0, 0}},
        {12, 12, 25, 50, 200, Speed::AVERAGE, 0, 0, _("Green Dragon"), _("Green Dragons"), {3000, 0, 0, 0, 1, 0, 0}},
        {13, 13, 25, 50, 240, Speed::FAST, 0, 0, _("Red Dragon"), _("Red Dragons"), {3500, 0, 0, 0, 1, 0, 0}},
        {14, 14, 25, 50, 280, Speed::VERYFAST, 0, 0, _("Black Dragon"), _("Black Dragons"), {4000, 0, 0, 0, 2, 0, 0}},

        // atck dfnc  min  max   hp             speed grwn  shots  name                  multiname            cost
        {2, 1, 1, 3, 3, Speed::SLOW, 8, 12, _("Halfling"), _("Halflings"), {55, 0, 0, 0, 0, 0, 0}},
        {5, 4, 2, 4, 15, Speed::VERYFAST, 6, 0, _("Boar"), _("Boars"), {155, 0, 0, 0, 0, 0, 0}},
        ...
        {7, 8, 4, 8, 40, Speed::AVERAGE, 3, 0, _("Roc"), _("Rocs"), {400, 0, 0, 0, 0, 0, 0}},
        ...
        {13, 10, 20, 30, 155, Speed::AVERAGE, 0, 0, _("Giant"), _("Giants"), {2000, 0, 0, 0, 0, 0, 1}},
        {15, 15, 20, 30, 280, Speed::VERYFAST, 0, 24, _("Titan"), _("Titans"), {4500, 0, 0, 0, 0, 0, 2}},

        // atck dfnc  min  max   hp             speed grwn  shots  name                  multiname            cost
        {4, 3, 2, 3, 4, Speed::AVERAGE, 8, 0, _("Skeleton"), _("Skeletons"), {70, 0, 0, 0, 0, 0, 0}},
        {5, 3, 2, 3, 15, Speed::SLOW, 6, 0, _("Zombie"), _("Zombies"), {140, 0, 0, 0, 0, 0, 0}},
        {5, 3, 2, 3, 25, Speed::AVERAGE, 6, 0, _("Mutant Zombie"), _("Mutant Zombies"), {190, 0, 0, 0, 0, 0, 0}},
        {6, 7, 3, 4, 25, Speed::AVERAGE, 4, 0, _("Mummy"), _("Mummies"), {250, 0, 0, 0, 0, 0, 0}},
        {6, 7, 3, 4, 30, Speed::FAST, 4, 0, _("Royal Mummy"), _("Royal Mummies"), {300, 0, 0, 0, 0, 0, 0}},
        ...
        {7, 11, 8, 10, 30, Speed::FAST, 2, 12, _("Lich"), _("Liches"), {650, 0, 0, 0, 0, 0, 0}},
        {7, 13, 8, 10, 35, Speed::VERYFAST, 2, 24, _("Power Lich"), _("Power Liches"), {750, 0, 0, 0, 0, 0, 0}},
        {11, 9, 25, 45, 140, Speed::AVERAGE, 1, 0, _("Bone Dragon"), _("Bone Dragons"), {1600, 0, 0, 0, 0, 0, 0}},
